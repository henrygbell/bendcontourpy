...
class Experiment:
    """
    Simulates the bend contour intensity of .
    ...
    Parameters:
        ...
        or: 
            rotation_matrices (ndarray): Precomputed rotation matrices for the sample's rotation angles.
    """
    @classmethod
    def from_energy(cls, 
                   energy_kev: float,
        ...
        or:
            rotation_matrices: Precomputed rotation matrices for the sample's rotation angles
        """
    ...
    def set_rotation_matrices(
        ...
        # TODO: set rotation axis and angles too when you set rotation matrices
    ...
    def get_bright_field_projected(
        ...
        """
        Projects the computed bright field/dark field intensities onto a regular grid defined by x_reg and y_reg.
        
        Parameters:
            x_reg (ndarray): Regular grid for x-coordinates.
            y_reg (ndarray): Regular grid for y-coordinates.
            interpolation_method (str): Method for interpolation, either "nearest" or "bilinear".
            project_df (bool): Whether to project dark field intensities as well.
            
        Returns:
            I_bf_projected (ndarray): Projected bright field intensities.
            I_df_projected (ndarray, optional): Projected dark field intensities if project_df is True.
        """
    ...
    """
    Plotting methods for the Experiment class.
    """
